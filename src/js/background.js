...
browser.runtime.onInstalled.addListener((details) => {
    ...
    // This runs once and persists — no need for browser.action.onClicked.
    if (typeof chrome !== "undefined" && chrome.sidePanel) chrome.sidePanel.setPanelBehavior({ openPanelOnActionClick: false })
