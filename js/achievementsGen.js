(async function() {
    ...
    async function createAdvancementsShowroom() {
        ...
        const achievements = [
            ...
            { id: "taskSubmissionSound", name: "Sonido de Entrega de Tareas", description: "Logro por activar el sonido de dopamina al entregar tareas", icon: "fa-volume-up", unlocked: settings.features.taskSubmissionSound, category: "features", rarity: "epic" },
